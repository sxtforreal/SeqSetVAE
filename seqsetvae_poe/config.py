...
data_dir = os.environ.get(
    "SEQSET_PTN_DATA", "/home/sunx/data/aiiih/data/mimic/processed/SeqSetVAE"
)
params_map_path = os.environ.get(
    "SEQSET_STATS", "/home/sunx/data/aiiih/data/mimic/processed/stats.csv"
)
