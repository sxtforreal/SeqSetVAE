...
def main():
    ...
    parser.add_argument(
        "--output_dir", type=str, default=None, help="Experiment output dir (default ./outputs/<run_name>)"
    )
    parser.add_argument(
        "--resume_ckpt",
        type=str,
    ...
    ckpt = ModelCheckpoint(save_top_k=1, monitor="val_loss", mode="min", filename="poe_GRU_PT")
